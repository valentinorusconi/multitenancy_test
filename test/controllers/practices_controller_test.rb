...
class PracticesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create practice" do
    assert_difference("Practice.count") do
      post practices_url, params: { practice: { name: @practice.name, slug: @practice.slug } }
    end
  ...
  test "should update practice" do
    patch practice_url(@practice), params: { practice: { name: @practice.name, slug: @practice.slug } }
